...
@section('pagecontent')
      ...
      <div>
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <h5 style="margin: 0;">Acerca de JabPrice</h5>
              <hr>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 text-justify">
              <p>JabPrice es uno de los comparadores de precios más destacados de México con millones de productos a comparar. El gran número de tiendas y ofertas que consideramos aumenta las posibilidades de que encuentres el precio más barato del producto que buscas. </p>
