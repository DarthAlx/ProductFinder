								...
								<tr>
										...
										<table width="100%" class="textb" border="0" cellspacing="0" cellpadding="6">
												<tbody>
														<tr>
																<td colspan="2"><br />
																	Tienes un nuevo mensaje desde registro de marca ProductFinder.
																<hr />
																</td>
														</tr>
														<tr>
														...
														<tr>
																<td align="left" style="width: 50%;"><strong>Empresa:</strong></td>
																<td class="text">{{ $datos->empresa}}</td>
														</tr>
														<tr>
																<td align="left" style="width: 50%;"><strong>Página web:</strong></td>
																<td class="text">{{ $datos->url}}</td>
														</tr>
														<tr>
