            ...
            <ul class="collection">
              ...
              @foreach($relacionados as $producto)
                      ...
                      <form action="{{url('/producto')}}" method="post" id="tendencia{{$relacionadocount}}"  enctype="multipart/form-data" style="display: none;" >
                        ...
                        <input type="submit" id="tendenciabutton{{$relacionadocount}}" style="display: none;">
                      </form>
                      ...
                      <li class="collection-item">
                        <div class="">
                          @foreach ($items as $product)
                             ...
                             @endif         
                          @endforeach
                          <a class="fav{{$relacionadocount}}0" onclick="addtofavorite('{{$nombre}}','{{$enlace}}','{{$precio}}','{{$imagen}}','{{$tienda}}','{{$url}}', 'fav{{$relacionadocount}}')" style="color: inherit;">
                            <i class="fa fa-heart-o fa-lg" aria-hidden="true"></i>
                          </a>
                         
                          <a class="fav{{$relacionadocount}}1" style="display: none; color: inherit;">
                        ...
                        <!--a style="cursor: pointer; text-decoration: none; color: inherit;"  onclick="document.getElementById('tendenciabutton{{$relacionadocount}}').click();"-->
                          <div class="row">
                            <div class="valign-wrapper">
                                <div class="col-md-3">
                                    <!--div class="img-container text-center">
                                      ...
                                      <div class="name">
                                          ...
                                          <h6><b>{{str_limit($producto['nombre_producto'], $limit = 35, $end = '...')}}</b></h6>   
                                        </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <a href="{{$producto['url']}}" target="_blank" class="btn btn-primary" style="width: 100%">Ver oferta</a>
                                </div>
                            </div>  
